import { useLoaderData, useActionData, Form, json } from "@remix-run/react";
...
export default function Upload() {
  ...
  const handlePdfClick = (e, fileUrl) => {
    ...
    window.open(googleDocsUrl, '_blank'); // Open the PDF in a new tab using Google Docs Viewer
  };
        ...
        <div className="mt-8">
          ...
          <div className="inline-block min-w-full overflow-hidden align-middle bg-white shadow-md rounded-lg">
            <table className="min-w-full">
              <thead>
                <tr>
                  <th className="px-6 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs leading-4 font-semibold text-gray-600 uppercase tracking-wider">File Name</th>
                </tr>
              </thead>
